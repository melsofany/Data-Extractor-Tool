...
const CATEGORIES = [
  ...
  {id:"مواد البناء والمقاولات",                 label:"🏗️ مواد البناء",              def:true},
  {id:"المعدات الطبية والصيدلانية",             label:"🏥 المعدات الطبية",           def:true},
  {id:"السيارات وقطع الغيار",                   label:"🚗 السيارات وقطع الغيار",     def:true},
  {id:"الأمن والحراسة وأنظمة المراقبة",         label:"🔒 الأمن والمراقبة",          def:true},
  {id:"التكييف والتبريد",                       label:"❄️ التكييف والتبريد",          def:true},
  {id:"معالجة المياه والصرف الصحي",             label:"💧 معالجة المياه",             def:true},
  {id:"الطباعة والنشر والإعلان",                label:"🖨️ الطباعة والإعلان",          def:true},
  {id:"الأغذية والمشروبات",                     label:"🍔 أغذية ومشروبات",           def:true},
  {id:"النسيج والملابس",                        label:"👕 نسيج وملابس",              def:true},
  {id:"الشحن والنقل واللوجستيات",               label:"🚛 شحن ونقل",                 def:true},
  {id:"الزراعة والري",                          label:"🌱 الزراعة والري",              def:true},
  {id:"العقارات والمقاولات",                    label:"🏢 العقارات",                  def:true},
...
buildGrid(CATEGORIES, 'catGrid', 'scraper_cats_v2');
buildGrid(GOVERNORATES, 'govGrid', 'scraper_govs_v2');
